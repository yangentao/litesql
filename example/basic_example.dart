...
void main() {
  ...
  // age TEXT
  // )
  int rowid1 = lite.insert("Person", ["name" >> "entao1", "age" >> 21, "add" >> "Jinan1"]);
  int rowid2 = lite.insert("Person", ["name" >> "entao2", "age" >> 22, "add" >> "Jinan2"]);
  int rowid3 = lite.insert("Person", ["name" >> "entao3", "age" >> 23, "add" >> "Jinan3"]);
